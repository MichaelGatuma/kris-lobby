...
{{--    </label>--}}
    ...
    <span class="inline-block w-full rounded-md shadow-sm">
      <button @click="open = true" type="button" aria-haspopup="listbox" aria-expanded="true" aria-labelledby="listbox-label" class="cursor-default relative w-full rounded-md border border-gray-300 bg-white pl-3 pr-10 py-2 text-left focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition ease-in-out duration-150 sm:text-sm sm:leading-5">
        ...
        <!--
          ...
          Leaving: "transition ease-in duration-100"
            ...
            To: "opacity-0"
        -->
        <div x-show="open" @click="open=false" @click.away="open = false" class="absolute mt-1 w-full rounded-md bg-white shadow-lg">
